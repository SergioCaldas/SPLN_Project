...
=head1 Descricao da Script
  Esta script faz uma comparacao das nossas frequencias com as frequencias calculadas pelo grupo 2 relativamente aos nomes
=cut
...
=head1 Open
  Funcao que abre a tabela de nomes do grupo 2 e grava na variavel his_tabela_nomes
=cut

open (my $his_tabela_nomes, "<", "../Grupo02/g2_tabela_nomes.txt") or die ("Impossivel abrir o ficheiro tabela_nomes_g2.txt\n");

=head1 Preenchimenento das Hash's
  Este excerto de codigo preenche uma hash com a informacao dos nomes do grupo 2
=cut
