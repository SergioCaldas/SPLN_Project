...
=head1 Descricao da Script
  Esta script faz uma comparacao das nossas frequencias com as frequencias calculadas pelo grupo 3 relativamente as cidades
=cut
...
=head1 Open
  Funcao que abre a tabela de cidades do grupo 3 e grava na variavel his_tabela_cidades
=cut

open (my $his_tabela_cidades, "<", "../Grupo03/tabela_cidades.txt") or die ("Impossivel abrir o ficheiro tabela_localidasdes_g2.txt\n");

=head1 Preenchimenento das Hash's
  Este excerto de codigo preenche uma hash com a informacao dos cidades do grupo 3
=cut
