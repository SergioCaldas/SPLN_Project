...
open (my $my_tabela_cidades, "<", "../Tabelas/tabela_cidades.txt") or die ("Impossivel abrir o ficheiro tabela_nomes.txt\n");
...
print "\nTotal de Cidades em comum nos dois grupos = $tcidades\n";
